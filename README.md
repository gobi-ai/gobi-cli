...
If you're an agent (a Grok Bot, or any assistant with a shell) connecting a **brand-new** user to Gobi, run this once, in order. Every step is a real command — run it and read what it says.
